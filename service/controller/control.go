...
func (c *Controller) GetOnlineDevice(tag string, userTraffic *sync.Map) (*[]api.OnlineUser, bool, error) {
	return c.dispatcher.Limiter.GetOnlineDevice(tag, userTraffic)
}
